...
*     5       ap     14/10/2017  criação de uma nova função
...
***********************************************************************/
   ...
   typedef enum {
		...
		LIS_CondRetListaNExiste  /* A Lista não foi criada */
   } LIS_tpCondRet ;
...
/***********************************************************************
*
*  $FC Função: LIS  &Contar Elementos da lista
*
*  $ED Descrição da função
...
*
*  $FV Valor retornado
*     -1: Lista não foi criada.
*     pLista->numElem: A quantidade de elementos da lista.
*
***********************************************************************/

  int LIS_ContaElementos(LIS_tppLista pLista);
